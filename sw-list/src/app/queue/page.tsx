...
async function load() {
    ...
    const avgWait = queue.length
        ? queue.reduce((sum, q) => sum + q.waitMs, 0) / queue.length
        : 0;
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-400 text-sm leading-relaxed">
                                We're a team of volunteers juggling school, work, and life stuff.
                                Some ships take longer to review depending on complexity - we promise we're getting to yours.
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                    <div className="content-box rounded-xl p-6">
                        ...
                        <p className="text-zinc-600 text-sm mt-2">
                            based on {data.reviewedCount} reviews
                        </p>
                ...
                <div className="content-box rounded-xl p-6 mb-8">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        {data.typeStats.length === 0 && (
                            <p className="text-zinc-600">no data yet</p>
                        )}
                    </div>
                </div>
